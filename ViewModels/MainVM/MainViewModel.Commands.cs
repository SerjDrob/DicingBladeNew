...
using HCLang = HandyControl.Properties.Langs;
    ...
    internal partial class MainViewModel
    {
        ...
        private void InitCommands()
		{
			TestKeyCommand = new KeyProcessorCommands(parameter => true)
				...
				.CreateKeyDownCommand(Key.OemMinus, async () => { await AlignWafer(); }, ()=>_isReadyForAligning)
                ;
                            ...
                            case Velocity.Step when res.Item1 == Ax.Y:
                                {
                                    ...
                                    var luft = 0.03;
                                    await _machine.MoveAxInPosAsync(Ax.Y, YView - luft + index, true);
